...
try:
    ...
    from optionsllm.main import summarize_options_data, ask_llm_about_options
    ...
    print(f"Error importing options modules: {e}")
...
def render_eod_chain_tab() -> None:
    ...
    if not ticker_input:
        ...
        if EOD_CHAIN_AVAILABLE:
            ...
            st.error("EOD Chain module not available. Please check that eod_chain.py is available.")
...
def render_strategy_viz_tab() -> None:
    ...
    if EOD_CHAIN_AVAILABLE:
        ...
        st.error("Widgets are not available. Please check that eod_chain.py is available.")
    ...
    if not ticker:
        ...
        if OPTIONS_VIZ_AVAILABLE:
            ...
            st.error("Options Visualization module not available. Please check that strategy.py is available.")
